...
> are geometry placeholders only. The current `balanced` baseline is body 34; always replace every text role with the locked `spec_lock.md` value and reflow geometry instead of inheriting these placeholder sizes.
...
`{{BODY_STACK}}` font_family. Current balanced readability placeholders: title 58, subtitle 44, lead 40, subheading
38, body 34, annotation 26, kicker 20, footnote 20, cover_title 96, hero 60. Always reflow from `spec_lock.md`.
...
<g id="header">
  ...
  <text x="72" y="140" font-family="{{TITLE_STACK}}" font-size="52" font-weight="600" fill="{{PRIMARY}}">{{TITLE}}</text>
...
<g id="footer">
  ...
  <text x="72" y="702" font-family="{{BODY_STACK}}" font-size="18" fill="{{TEXT_3}}">{{DECK_LABEL}}</text>
  <text x="1208" y="702" text-anchor="end" font-family="{{BODY_STACK}}" font-size="18" fill="{{TEXT_3}}">{{NN}} / {{TOTAL}}</text>
</g>
```
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" data-pptx-page-role="cover">
  ...
  <g id="headline">
    <text x="70" y="336" font-family="{{TITLE_STACK}}" font-size="90" font-weight="700" fill="{{PRIMARY}}">{{LINE_1}}</text>
    <text x="70" y="432" font-family="{{TITLE_STACK}}" font-size="90" font-weight="700" fill="{{ACCENT}}">{{LINE_2}}</text>
  </g>
  <g id="subhead">
    <text x="72" y="508" font-family="{{BODY_STACK}}" font-size="40" font-weight="500" fill="{{TEXT_2}}">{{SUBTITLE}}</text>
  </g>
  <g id="meta">
    <line x1="72" y1="628" x2="1208" y2="628" stroke="{{BORDER}}" stroke-width="1.5"/>
    <text x="72" y="670" font-family="{{BODY_STACK}}" font-size="22" fill="{{TEXT_2}}">{{META_LEFT}}</text>
...
<g id="item-{{i}}">
  ...
  <text x="72" y="{{Y}}" font-family="{{TITLE_STACK}}" font-size="34" font-weight="600" fill="{{ACCENT}}">{{NN}}</text>
  <text x="150" y="{{Y}}" font-family="{{TITLE_STACK}}" font-size="34" font-weight="600" fill="{{PRIMARY}}">{{LABEL}}</text>
  <text x="1208" y="{{Y}}" text-anchor="end" font-family="{{BODY_STACK}}" font-size="22" fill="{{TEXT_2}}">{{DESCRIPTOR}}</text>
</g>
```
...
Left panel x 72–470; vertical divider at x=516; right column x 560–1208 (**available 648** for body, verify with `text_fit.py -s 34 --x 560`).

```xml
<g id="concept">
  <use data-icon="{{ICON}}" x="72" y="212" width="56" height="56" fill="{{ACCENT}}"/>
  <text x="72" y="332" font-family="{{TITLE_STACK}}" font-size="34" font-weight="600" fill="{{PRIMARY}}">{{AREA_LABEL}}</text>
  <text x="72" y="392" font-family="{{BODY_STACK}}" font-size="34" fill="{{TEXT}}">{{DEF_L1}}<tspan x="72" dy="44">{{DEF_L2}}</tspan><tspan x="72" dy="44">{{DEF_L3}}</tspan></text>
</g>
...
<g id="ex-1">
  ...
  <text x="560" y="250" font-family="{{TITLE_STACK}}" font-size="34" font-weight="600" fill="{{ACCENT}}">{{ROW_LABEL_1}}</text>
  <text x="560" y="290" font-family="{{BODY_STACK}}" font-size="34" fill="{{TEXT}}">{{ROW_BODY_1}}</text>
</g>
...
<g id="step-1">
  ...
  <text x="72" y="404" font-family="{{TITLE_STACK}}" font-size="56" font-weight="700" fill="{{ACCENT}}">01</text>
  <text x="72" y="466" font-family="{{TITLE_STACK}}" font-size="34" font-weight="600" fill="{{PRIMARY}}">{{STEP_LABEL}}</text>
  <text x="72" y="512" font-family="{{BODY_STACK}}" font-size="34" fill="{{TEXT}}">{{STEP_L1}}<tspan x="72" dy="42">{{STEP_L2}}</tspan></text>
</g>
...
<g id="pullquote">
  <text x="72" y="264" font-family="{{TITLE_STACK}}" font-size="64" font-weight="700" fill="{{PRIMARY}}">{{QUOTE_L1}}</text>
  <text x="72" y="340" font-family="{{TITLE_STACK}}" font-size="64" font-weight="700" fill="{{ACCENT}}">{{QUOTE_L2}}</text>
  <rect x="74" y="378" width="72" height="4" fill="{{ACCENT}}"/>
  <text x="72" y="430" font-family="{{BODY_STACK}}" font-size="34" fill="{{TEXT_2}}">{{STANDFIRST}}</text>
</g>
<g id="principle-1">
  <line x1="72" y1="486" x2="1208" y2="486" stroke="{{BORDER}}" stroke-width="1"/>
  <text x="72" y="530" font-family="{{TITLE_STACK}}" font-size="34" font-weight="600" fill="{{ACCENT}}">{{P_LABEL_1}}</text>
  <text x="212" y="530" font-family="{{BODY_STACK}}" font-size="34" fill="{{TEXT}}">{{P_BODY_1}}</text>
</g>
<!-- principle-2: hairline 562, text 606 ; principle-3: hairline 638, text 682 (keep last row ≤ y 700) -->
```
Pull-quote 52px is a breathing hero (in-band feature size, ~2.2× body). Keep principle bodies ≤ ~40 CJK at x=212 (verify `text_fit.py -s 34 --x 212`).
