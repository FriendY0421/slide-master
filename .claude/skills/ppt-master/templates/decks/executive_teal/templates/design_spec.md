---
deck_id: executive_teal
kind: deck
category: scenario
summary: 보고·제안용 청록 전략 덱 — 경영진 보고, 개선안, 실행 로드맵
...
# Executive Teal Strategy Deck — Design Specification
...
| Primary navy | `#0F766E` | Structure, primary series, key numbers |
