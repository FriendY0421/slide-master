---
deck_id: strategy_burgundy
kind: deck
category: scenario
summary: 버건디 포인트 전략 보고 덱 — 이슈 분석, 의사결정, 실행계획
...
# Strategy Burgundy Strategy Deck — Design Specification
...
| Primary navy | `#7F1D1D` | Structure, primary series, key numbers |
