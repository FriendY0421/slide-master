...
def _html_page(entries: list[dict], recommended: set[str], source_label: str, purpose: str) -> str:
    ...
    registered_count = sum(1 for e in entries if e.get("id") != "free")
...
<div class="meta">등록 템플릿 {registered_count}종 + Free Design 1개 · 선택 옵션 {option_count}개 · GitHub 기준본 · {source_html}</div><section id="grid" class="grid"></section>
